    ...
    <div className="rapidus-container">
      ...
      <div className="rapidus-main">
        <nav className="side-nav">
          <ul>
          <li className="white-box"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTj-38wv8s_hOvue2DIVKf1sqwW5b5m75e-bRU2DubgOtrIVR5jVtN2vz8ggXmvj-UA_Zw&usqp=CAU" style={{ width: '100%', height: '18px', objectFit: 'cover', marginl: '0px' }} /></li>
